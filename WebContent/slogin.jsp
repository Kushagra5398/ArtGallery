...
<body>
	...
	<div class="col-md-6 col-sm-6 col-xs-6">
			<form class="form-horizontal" action="slogin" method="post">
					...
					<div class="form-group"> 
					  <div class="col-sm-offset-2 col-sm-10">
						<div class="checkbox">
						  <a href="forgot.jsp" class="btn btn-info  btn-xs">Forgot Password</a>
						</div>
					  </div>
					</div>-->
	...
	<div class="container col-md-6 col-sm-6 col-xs-6">
			<form class="form-horizontal" action="Sregister" method="post">
					<div class="form-group">
					...
					<div class="form-group">
						<label type="tel" pattern="[0-9]{10}" class="control-label col-sm-2" for="Mobile">Mobile Number:</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
					  <label class="control-label col-sm-2" for="pwd">Password:</label>
					  <div class="col-sm-8"> 
						<input type="password" type="tel" pattern="[A-Z]{1}" class="form-control" name="pwd" placeholder="Enter password">
					  </div>
					</div>
					<div class="form-group">
				...
				<!-- 	<div class="form-group"> 
					...
					<div class="membership">
							...
							<div class="input-checkbox">
								<input type="radio" name="membership" id="membership-1" value="Free" checked>
