...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="com.exhibition" %>
    ...
    %>   
    <%
    String exe[]=new String[15];
       	exhibition ex=new exhibition();
  try{ exe=ex.array(); }catch(Exception e){}
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<a  href="checkout.jsp?aid=<%= description[0]%>">
					<img src=".<%=description[8]%>" alt=""  height="450"></a>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="scrollbar scrollbar-primary " style="height: 100%; ">
							<div class="force-overflow">
								<br><center><h1>Title : <%=description[1]%></h1></center><br>
								<h2>Artist : <%=description[3] %> </h2><br>
								<h2>Exhibition Date : <%=description[12] %></h2>
								<h2>Painting Style : <%=description[10] %></h2>
								<h2>Description : </h2><h3><%=description[2] %></h3>
								<div class="banner-caption text-center">
									<h2 class="white-color">NEW COLLECTION</h2>
								</div>
					  		</div>
