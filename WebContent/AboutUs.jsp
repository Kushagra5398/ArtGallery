...
<body>
		    	...
		    	<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown">
							...
							<ul class="custom-menu">
								...
								<li><a href="slogin.jsp"><i class="fa fa-unlock-alt"></i> Login</a></li>
								<li ><a href="slogout.jsp"><i class="fa fa-unlock-alt" ></i> Logout</a></li>
							</ul>
						</li>
						<!-- /Account -->
	...
	<div class="container">
		<h2>About Us</h2>
		<h4>The Gitanjali art gallery is intended to provide beautiful paintings to customer. It will enable user and artist to search for paintings. user to browse online paintings and purchase them online. The purpose of this document is to present a detailed description of the Gitanjali art gallery. It will explain the purpose and features of the system, the interfaces of the system, what the system will do, the constraints under which it must operate and how the system will react to external stimuli. This document is intended for both the stakeholders and the developers of the system. </h4>
 <h4>HANDCRAFTED BY:-</h4>
<h4>MISHRA ADITYA KUMAR V.</h4>
<h4>MAYANK PRATAP SINGH</h4>
<h4>DEEPAK GUPTA</h4>
<h4>CHETANYA SHARMA</h4>
<h4>VISHAL  JAISWAL</h4>
</h4>
	</div>
<!-- FOOTER -->
