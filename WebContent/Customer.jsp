...
int start=img.StartingIndex();
   ...
   int  flag=0;
    try{  	CustomerLogin customer=new CustomerLogin();
   					String cid=session.getAttribute("cid").toString();
    				profile=customer.getData("cid");
    				flag=1;
    			}
    	catch(Exception e){}
       %>
...
<!-- HOME -->
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-8"> 
						<input type="text" class="form-control" name="address" placeholder="Enter password" value="<%=profile[4]%>">
					  </div>
					</div>
					<div class="form-group"> 
		...
		<div class="container col-md-12 col-sm-12 col-xs-12">
			<%
				...
				{ int i=0;
			%>
			<center><h3 class="text-info">List paintings buy by you.</h3></center>
			<div class="container col-md-12 col-sm-12 col-xs-12">
                    ...
                    <thead>
                        <tr class="bg-info text-light">
                            ...
                            <th class="text-center">Shipping Mode</th>
                            <th class="text-center">Payments Mode</th>
                        </tr>
                    </thead>
                    <tbody>
			<%	
					try
					{
						...
						ResultSet resultSet=st.executeQuery("SELECT * FROM sale where cid="+session.getAttribute("cid").toString());
						while(resultSet.next())
						{ 
						%>
						<tr class="text-info">
                            <td class="text-center"><%=++i %></td>
                            <td class="text-center"><% String title1[]=q.getQuery(resultSet.getString(2));%><%=title1[1] %></td>
