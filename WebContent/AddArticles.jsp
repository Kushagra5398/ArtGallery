...
<body>
	...
	<div class="section">
		...
		<div class="container">
			...
			<form class="form-horizontal" action="Upload	Article" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6"> 
						<input type="text" class="form-control" name="Artist" placeholder="Enter artist Name">
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-4" for="Mrp">M.R.P:</label>
					  <div class="col-sm-6">
						<input type="text" class="form-control" name="Mrp" placeholder="Enter M.R.P.">
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-4" for="">Selling Price</label>
					  <div class="col-sm-6"> 
						<input type="text" class="form-control" name="SellinpPrice" placeholder="Enter description">
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6"> 
						<input type="text" class="form-control" name="Location" placeholder="Enter City" >
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6"> 
						<input type="text" class="form-control" name="painting_style" placeholder="Enter Painting Style">
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6"> 
						<input type="textarea" class="form-control" name="exhibition" placeholder="Enter 'yes' or 'no' for Exhibition">
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6"> 
						<input type="text" class="form-control" name="exhibition_date" placeholder="Enter Exhibition Date in dd/mm/yyyy">
					  </div>
					</div>
